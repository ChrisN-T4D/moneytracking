  ...
  const collections: Array<{ name: string; fields: unknown[] }> = [
    ...
    },
    {
      ...
      fields: [
        ...
        textField("spendCategory", false),
        textField("cadence", false),
        textField("categorySource", false),
        numberField("categoryConfidence", false),
        textField("categorizedAt", false),
        textField("categoryModel", false),
      ],
    },
    {
      name: "statement_category_corrections",
      fields: [
        textField("statementId", true),
        textField("pattern", true),
        textField("fromCategory", false),
        textField("toCategory", true),
        textField("fromCadence", false),
        textField("toCadence", true),
        textField("createdAt", true),
      ],
    },
    {
      name: "goals",
